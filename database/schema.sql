...
('Traditional Middle Eastern Feast', 'خۆراکی نەریتی ناوەڕاستی ئاسیا', 'وليمة شرق أوسطية تقليدية', 'A complete traditional Middle Eastern dining experience featuring our most popular dishes', 'ئەزموونێکی تەواوی خۆراکی نەریتی ناوەڕاستی ئاسیا لەگەڵ خۆراکە بەناوبانگەکانمان', 'تجربة طعام شرق أوسطية تقليدية كاملة تضم أشهر أطباقنا', 35.00, 10, '["Kebab-e Kubideh", "Dolma", "Yaprakh", "Ash-e Reshteh", "Middle Eastern Rice", "Fresh Bread", "Dessert", "Tea Service"]'),
('Vegetarian Delight', 'خۆراکی ڕووەکی', 'متعة نباتية', 'A carefully curated selection of our finest vegetarian and vegan Middle Eastern dishes', 'هەڵبژاردەیەکی وردبینانە لە باشترین خۆراکە ڕووەکی و ڤێگانەکانی ناوەڕاستی ئاسیا', 'مجموعة مختارة بعناية من أجود الأطباق الشرق أوسطية النباتية والنباتية الصرفة', 28.00, 10, '["Dolma", "Khorak-e Bademjan", "Middle Eastern Salads", "Stuffed Peppers", "Lentil Soup", "Hummus Selection", "Fresh Bread", "Baklava"]'),
